...
MQTT_CLIENT_KEY = "****-private.pem.key" # AWS private Key
MQTT_CLIENT_CERT = "****-certificate.pem.crt" # AWS signed certificate
MQTT_CLIENT_ID = ubinascii.hexlify(machine.unique_id())

MQTT_BROKER = "****-ats.iot.us-east-2.amazonaws.com" # AWS domain
